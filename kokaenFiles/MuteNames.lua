...
if DevAbs:get(kokaen.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(kokaen.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(kokaen.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(kokaen.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(kokaen.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(kokaen.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
kokaenName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if kokaenName then 
kokaenNames = DevAbs:smembers(kokaen.."Abs:Mute:Names"..msg.chat_id_) or ""
if kokaenNames and kokaenNames[1] then 
for i=1,#kokaenNames do 
if kokaenName:match("(.*)("..kokaenNames[i]..")(.*)") then 
...
DevAbs:set(kokaen.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(kokaen.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
